...
const SideBar = () => {
    ...
    return (
        <div className='md:w-[10%] w-2/12 bg-white h-screen md:-translate-y-16 -translate-y-11 z-20 flex flex-col'>
            <div className="bg-indigo-400 w-full flex items-center justify-center">
